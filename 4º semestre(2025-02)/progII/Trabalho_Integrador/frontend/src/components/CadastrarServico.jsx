...
function CadastrarServico() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            console.error(error); 
            alert('Erro ao lançar serviço. Verifique os dados!');
        }
    }

    return (
        <Paper elevation={3} sx={{ p: 4, mt: 4, maxWidth: 900, mx: 'auto' }}>
            <Typography variant="h5" gutterBottom sx={{color: '#ed6c02', mb: 3, fontWeight: 'bold'}}>
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} md={4}>
                        <TextField 
                            ...
                            sx={{ '& input::-webkit-calendar-picker-indicator': { cursor: 'pointer', filter: 'invert(0.5)', fontSize: '1.5rem' } }}
                        />
                    </Grid>
                    <Grid item xs={12} md={4}>
                        <TextField 
                            label="Hora" type="time" fullWidth required 
                            InputLabelProps={{ shrink: true }}
                    ...
                    <Grid item xs={12} md={4}>
                        <TextField 
                            label="Valor (R$)" fullWidth required
                            placeholder="0.00"
                    ...
                    <Grid item xs={12} md={4}>
                        <TextField 
                            label="ID do Técnico" type="number" fullWidth required
                            placeholder="Ex: 2"
                    ...
                    <Grid item xs={12}>
                        <TextField 
                            label="Descrição do Serviço" multiline rows={3} fullWidth required
